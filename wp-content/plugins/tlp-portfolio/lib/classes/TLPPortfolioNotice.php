                ...
                <div class="notice rtport-review-notice rtport-review-notice--extended">
                    <div class="rtport-review-notice_content">
                        ...
                        <div class="rtport-review-notice_actions">
                            ...
                            <a href="<?php echo esc_url($remind_me); ?>" class="rtport-review-button rtport-review-button--cta rtport-review-button--outline"><span>🔔 Remind Me Later</span></a>
                            <a href="<?php echo esc_url($dont_disturb); ?>" class="rtport-review-button rtport-review-button--cta rtport-review-button--error rtport-review-button--outline"><span>😐 No Thanks</span></a>
                        </div>
                    </div>
                </div>
                <?php
