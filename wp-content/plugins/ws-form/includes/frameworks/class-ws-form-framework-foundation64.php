			...
			return array(
				...
				'fields' => array(
					...
					'public' => array(
						...
						// Invalid feedback
						'mask_invalid_feedback'		=>	'<span id="#invalid_feedback_id" data-form-error-for="#id" class="#invalid_feedback_class" aria-hidden="true"#attributes>#invalid_feedback</span>',
