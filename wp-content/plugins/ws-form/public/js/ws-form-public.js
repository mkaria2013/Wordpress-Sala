(function($) {
	...
	$.WS_Form.prototype.form_bypass = function(conditional_initiated) {
		...
		for(var attribute_source in attributes) {
			...
			var attribute_source_objs = $('[' + attribute_source + ']', this.form_canvas_obj).length;
			var attribute_bypass_objs = $('[' + attribute_bypass + ']', this.form_canvas_obj).length;
